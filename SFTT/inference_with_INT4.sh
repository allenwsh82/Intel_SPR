...
#numactl -C 0-47,96-143  python inference_with_INT4.py --prompt "What is the total Nike earnings before interest and taxes in fiscal year 2022 in Europe, Middle East and Africa?
" --n-predict 200
